    ...
    jQuery(".item .picframe")
      ...
      .on("mouseleave", function() {
        ...
        jQuery(this)
          ...
          .find(".pf_text")
          .stop(true)
          .animate({ "margin-top": newheight - 30 }, 300, "easeOutCubic");
        jQuery(this)
          .parent()
          .find(".overlay")
          .stop(true)
...
// Pull data to dynamically create before/after Images
// const data = [
//   {
//     id: 1,
...
// const buildMainBeforeAfterCard = art => {
